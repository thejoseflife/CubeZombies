package com.cubezombies.main;
	...
	public class Animation {
		...
		public void drawAnimation(Graphics g, double x, double y, int offset, BasicZombie bz){
			g.drawImage(currentImg, (int)x - offset, (int)y, (int)bz.width, (int)bz.height,null);
			
		}
		
		public void drawAnimation(Graphics g, double x, double y, int offset, BossZombie bz){
			g.drawImage(currentImg, (int)x - offset, (int)y, (int)bz.width, (int)bz.height,null);
